...
export interface ReaderPollResultData {
  name: string;
  voters: number;
  options: ReaderPollResultOption[];
}
...
export interface DiscourseUserProfileResponse {
  user?: {
    id?: unknown;
    username?: unknown;
    name?: unknown;
...
export interface TopicReaderAuthor {
  id: number | null;
  username: string;
  name: string;
  avatarUrl: string;
...
export interface TopicReaderData {
  id: number;
  title: string;
  url: string;
  slug: string;
...
export interface ReaderUserProfileData {
  id: number | null;
  username: string;
  name: string;
  avatarUrl: string;
