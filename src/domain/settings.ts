...
export const SETTINGS_STORAGE_KEY = 'linuxdoReaderSettings';
export const LEGACY_SETTINGS_STORAGE_KEY = 'linuxdoCardViewSettings';
...
export function normalizeSettings(value: unknown): ExtensionSettings {
  ...
  return {
    ...
    readerPostBatchSize: boundedInteger(
      input.readerPostBatchSize,
      READER_POST_BATCH_MIN,
      READER_POST_BATCH_MAX,
      DEFAULT_SETTINGS.readerPostBatchSize,
    ),
    newTopicNoticeEnabled: booleanSetting(
      input.newTopicNoticeEnabled,
      DEFAULT_SETTINGS.newTopicNoticeEnabled,
    ),
